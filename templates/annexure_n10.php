...
$pdf->Cell(0, 10, 'Annexure-N10', 0, 1, 'C');
$pdf->SetFont('Arial', 'B', 10);

// Line 1
$pdf->Cell(0, 7, '(No Objection Certificates of OC/IC of the Police Station for holding Procession/Rally)', 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->SetFont('Arial', '', 9);
$pdf->Write(8, " Party for holding holding Procession/Rally* (from) ");
$pdf->SetFont('Arial', 'BU', 9);
...
// --- ROUTE & TIME ---
$pdf->SetFont('Arial', '', 9);
$pdf->Write(8, "Procession Route details (AC, Block may be mentioned): ");
$pdf->SetFont('Arial', 'BU', 9);
$pdf->MultiCell(0, 7, $data['place'] . " / AC - " . $data['ac_name'] . " / PS - " . $data['police_station'], 0, 'L');
$pdf->Ln(5);

$pdf->SetFont('Arial', '', 9);
$pdf->Write(8, "Disruption of Law & Order is apprehended/not apprehended for holding Procession/Rally *. ");
$pdf->Ln(7);

$pdf->SetFont('Arial', '', 9);
$pdf->Write(8, " Hence, NOC for holding holding Procession/Rally* from ");
$pdf->SetFont('Arial', 'BU', 9);
$pdf->Write(8, $data['place']);
$pdf->SetFont('Arial', '', 9);
$pdf->Write(8, " (to) on ");
